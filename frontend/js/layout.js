...
const ICONS = {
  ...
  admin_mgmt: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>`,
...
function getNavConfig(roleId) {
  ...
  if (roleId === 1) { // Admin — sees everything
    return [
      ...
      { section: 'Сотрудники' },
      { label: 'Администраторы', icon: 'admin_mgmt', href: 'pages/admins.html', key: 'admins' },
      { section: 'Аналитика' },
